...
l1_route_definitions: List[Dict[str, Any]] = [
    {
        ...
        "keywords": ["log in", "login", "signin", "sign in", "authenticate", "access", "log out", "logout", "sign out", "exit", "disconnect", "register", "signup", "sign up", "create account", "new user", "enroll", "password", "forgot", "reset", "change password", "change my password", "update password", "update my password", "locked out", "credentials"]
    },
    {
        ...
        "description": (
         ...
         "keywords": ["balance", "funds", "money", "history", "transaction", "statement", "activity", "spending", "payments", "deposits", "withdrawals", "details", "number", "account number", "id", "account id", "type", "account type", "update name", "update my name", "change name", "change name", "correct my name", "holder name"," account name", "legal name", "login name", "display name", "username", "profile name"]
    },
    {
...
l2_account_tool_definitions: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "keywords": ["holder name", "legal name", "official name", "primary name", "update name", "correct name", "fix spelling", "maiden name"]
    },
    {
        "name": "L3_LoginNameUpdateToolNode",
        "description": "Change the username or display name for login/profile.",
        "keywords": ["login name", "display name", "username", "screen name", "update name","nickname", "profile name", "alias", "user id"]},
    {
...
l2_support_tool_definitions: List[Dict[str, Any]] = [
    {
        ...
        "keywords": ["hours", "open", "opening", "closed", "bank", "times", "holiday", "contact", "phone", "call", "email", "location", "address", "branch", "atm", "fees", "charges", "rates", "interest", "website", "app", "cost", "service"]
    },
    {
